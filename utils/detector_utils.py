...
def draw_box_on_image(num_object_detect, score_thresh, scores, boxes, classes, im_width, im_height, image_np, Line_Position, Orientation):
    ...
    # here you can relace no of classes(person detected on the screen)
    for i in range(0, 1):
        ...
        if (scores[i] > score_thresh):
            ...
            # cv2.putText(image_np, 'person', (int(left), int(top)-5),
            ...
            alertcheck.drawboxtosafeline(
                image_np, p1, p2, Line_Position, Orientation)
